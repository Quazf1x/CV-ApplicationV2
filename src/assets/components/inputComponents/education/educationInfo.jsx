...
function EducationInfo({inputData, infoState, handleRemoval, handleChange}) {
  ...
  return(
    ...
    <div className="input-section-padding pretty-background">
      <h1>Education</h1>
      {isForm ? <EducationForm inputData={inputData} infoState={infoState} handleClick={handleClick} handleChange={handleChange} handleCancel={handleClick}/> 
