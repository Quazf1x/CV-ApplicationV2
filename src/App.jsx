  ...
  return (
    <div className="App">
      <section id="input-section">
        ...
        <PersonalInfo
          inputData={inputData.personalInfo}
          handleChange={handlePersonalInfo}
        />
        <MiscInfo handleChange={handleMiscInfo} />
        <AttributeInfo
          name="Education"
          inputData={inputData.education}
          infoState={educations}
          handleRemoval={removeEducation}
          handleChange={handleNewEducation}
        />
        <AttributeInfo
          name="Job Experience"
          inputData={inputData.jobExperience}
          infoState={jobExperiences}
          handleRemoval={removeJob}
          handleChange={handleNewJob}
        />
      </section>
